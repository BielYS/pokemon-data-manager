...
const getAPIData_1 = require("./modules/getAPIData");
...
function pokemonManager() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const data = yield (0, getAPIData_1.getAPIData)(url);
            console.log((0, camelCase_1.toCamelCase)("biel"));
            console.log((0, camelCase_1.toCamelCase)("KEVIN"));
